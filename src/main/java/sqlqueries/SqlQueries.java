...
public class SqlQueries {
    ...
    //language=HSQLDB
    String select02 = "SELECT * FROM EMPLOYEE WHERE CHARACTER_LENGTH(lastname) <= 5 ORDER BY lastname ASC;";
    ...
    //language=HSQLDB
    String select06 = "SELECT LASTNAME, SALARY, NAME AS DEPNAME FROM EMPLOYEE E LEFT JOIN " +
    ...
    //language=HSQLDB
    String select08 = "SELECT NAME AS DEPNAME, COUNT(ID) AS STAFF_SIZE FROM DEPARTMENT D JOIN " +
            "EMPLOYEE E ON D.ID = E.DEPARTMENT GROUP BY DEPNAME";

    //Select all departments and values of total and average salary per department
    //Name column containing name of the department "depname".
    //language=HSQLDB
    String select09 = "SELECT NAME AS DEPNAME, SUM(SALARY) AS TOTAL, AVG(SALARY) AS AVERAGE FROM DEPARTMENT D JOIN " +
            "EMPLOYEE E ON D.ID = E.DEPARTMENT GROUP BY DEPNAME";
    ...
    //language=HSQLDB
    String select10 = "SELECT E.LASTNAME AS EMPLOYEE, M.LASTNAME AS MANAGER FROM EMPLOYEE E LEFT JOIN " +
